...
import { bytecode as ERC721LazyMintBytecode } from "../artifacts/contracts/ERC721LazyMint.sol/ERC721LazyMint.json";
...
async function main() {
  ...
  const tx = await factory.deploy(SALT, ERC721LazyMintBytecode, {
    gasLimit: 8_000_000,
  });
